    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto text-white">
        ...
        <div className="space-y-6">
          ...
          {/* Date Range */}
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-300">Date Added Range</label>
          ...
          {/* Stock Status */}
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-300">Stock Status</label>
            <div className="grid grid-cols-2 gap-2">
