...
interface ExportPromotionsModalProps {
  isOpen: boolean
  onClose: () => void
...
export const ExportPromotionsModal = ({
  isOpen,
  onClose,
  onExport
}: ExportPromotionsModalProps) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto text-white">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">Export Promotions</h2>
