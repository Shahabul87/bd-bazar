...
import { FavoriteArticle } from "@prisma/client"; // Import FavoriteArticle from Prisma Client
import Link from "next/link";
import { motion } from "framer-motion";

interface MyFavoriteArticleCardProps {
  article: FavoriteArticle;
}

const MyFavoriteArticleCard: React.FC<MyFavoriteArticleCardProps> = ({ article }) => {
  return (
      ...
      >
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mt-4 text-gray-500 text-sm">
            <span>Position: {article.position}</span>
