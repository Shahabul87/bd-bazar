              ...
              <FormItem>
                ...
                <div className="flex gap-4">
                  ...
                  <select
                    ...
                    className="w-32 p-2 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-100"
                  >
                    <option value="pounds" className="text-gray-100">lbs</option>
                    <option value="kg" className="text-gray-100">kg</option>
                  </select>
                </div>
                <FormMessage className="text-red-400" />
              </FormItem>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-xs text-gray-400">
                  Specify the main material used in the product
                </FormDescription>
                <FormMessage className="text-red-400" />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-xs text-gray-400 mt-2">
                  Include all relevant technical details and specifications
                </FormDescription>
                <FormMessage className="text-red-400" />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-xs text-gray-400 mt-2">
                  Specify warranty duration and coverage details
                </FormDescription>
                <FormMessage className="text-red-400" />
              </FormItem>
            )}
